...
import type { CarouselArrowButtonProps, CarouselArrowButtonsProps } from 'src/components/carousel';
...
import { carouselClasses } from 'src/components/carousel';

import BotonCarrusel from './Boton';
