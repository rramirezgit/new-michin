...
import { CartComponent } from 'src/components/CartComponent/cart-component';
...
import { SignInIconButton } from '../components/sign-in-button';
      ...
      slots={{
        ...
        leftArea: (
          <>
            ...
            {/* -- Logo -- */}
            <Logo data-slot="logo" width={smUp ? 170 : 147} height={smUp ? 60 : 40} />
        ...
        centerArea: slots?.rightAreaStart,
        rightArea: (
          <>
            <Box
              data-area="right"
